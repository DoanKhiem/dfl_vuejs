          ...
          <div class="col-lg-3 order-2 order-lg-1">
            <div class="sidebar">
                ...
                <ul class="sidbar-style">
                  ...
                  <li class="form-check">
                    <input
                      ...
                      type="checkbox"
                    />
                    <label class="form-check-label" for="GamePad"
                      >GamePad (8)</label
                    >
                  </li>
                  <li class="form-check">
              ...
              <div class="col-img">
                <a href="shop.html"
                  ><img
                    src="../assets/img\banner\banner-sidebar.jpg"
                    alt="slider-banner"
                /></a>
              </div>
              <!-- Single Banner End -->
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-8 col-md-7 col-sm-12">
                        <div class="pro-content hot-product2">
                          <h4>
                            <a href="product.html"
                              >Accessorize with a straw hat</a
                            >
                          </h4>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-8 col-md-7 col-sm-12">
                        <div class="pro-content hot-product2">
                          <h4>
                            <a href="product.html"
                              >Tretchy Material Comfortable</a
                            >
                          </h4>
                          <p>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-8 col-md-7 col-sm-12">
                        <div class="pro-content hot-product2">
                          <h4>
                            <a href="product.html"
                              >Neckline Short Sleeves Stretchy</a
                            >
                          </h4>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-8 col-md-7 col-sm-12">
                        <div class="pro-content hot-product2">
                          ...
                          <p>
                            <span class="price">$152.19</span
                            ><del class="prev-price">$160.50</del>
                          </p>
                          <p>
                            Faded short sleeves t-shirt with high neckline. Soft
                            and stretchy material for a comfortable fit.
                      ...
                      <div class="col-lg-8 col-md-7 col-sm-12">
                        <div class="pro-content hot-product2">
                          ...
                          <p>
                            ...
                            ><del class="prev-price">$16.50</del>
                          </p>
                          <p>
                            Faded short sleeves t-shirt with high neckline. Soft
                            and stretchy material for a comfortable fit.
                ...
                <div class="pro-pagination">
                  ...
                  <div class="product-pagination">
                    <span class="grid-item-list"
                      >Showing 1 to 12 of 51 (5 Pages)</span
                    >
                  </div>
                </div>
