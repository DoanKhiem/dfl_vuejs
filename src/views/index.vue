...
export default {
  components: { HeaderArea, NewsletterPopup, VerticalMenu, SliderArea }
};
</script>
<template>
  ...
  <div class="wrapper">
    ...
    <!-- <div class="popup_banner">
            ...
            <div class="banner_popup_area">
                    <img src="@/assets/img\banner\pop-banner.jpg" alt="">
            </div>
        </div> -->
    <!-- Banner Popup End -->
    ...
    <div class="image-banner pb-50 off-white-bg">
      <div class="container">
        <div class="col-img">
          <a href="#"
            ><img src="@/assets/img\banner\h1-banner.jpg" alt="image banner"
          /></a>
        </div>
      </div>
      <!-- Container End -->
          ...
          <div class="single-product">
            ...
            <div class="pro-img">
              <a href="product.html">
                <img
                  class="primary-img"
                  src="@/assets/img\products\42.jpg"
                  alt="single-product"
                />
                <img
                  class="secondary-img"
                  src="@/assets/img\products\43.jpg"
                  alt="single-product"
                />
              </a>
              <div class="countdown" data-countdown="2020/03/01"></div>
          ...
          <div class="single-product">
            ...
            <div class="pro-img">
              <a href="product.html">
                <img
                  class="primary-img"
                  src="@/assets/img\products\30.jpg"
                  alt="single-product"
                />
                <img
                  class="secondary-img"
                  src="@/assets/img\products\31.jpg"
                  alt="single-product"
                />
              </a>
              <div class="countdown" data-countdown="2020/03/01"></div>
    ...
    <div class="big-banner mt-100 pb-85 mt-sm-60 pb-sm-45">
      <div class="container banner-2">
        <div class="banner-box">
          <div class="col-img">
            <a href="#"
              ><img src="@/assets/img\banner\banner3-1.jpg" alt="banner 3"
            /></a>
          </div>
          <div class="col-img">
            <a href="#"
              ><img src="@/assets/img\banner\banner3-2.jpg" alt="banner 3"
            /></a>
          </div>
        </div>
        <div class="banner-box">
          <div class="col-img">
            <a href="#"
              ><img src="@/assets/img\banner\banner3-3.jpg" alt="banner 3"
            /></a>
          </div>
        </div>
        <div class="banner-box">
          <div class="col-img">
            <a href="#"
              ><img src="@/assets/img\banner\banner3-4.jpg" alt="banner 3"
            /></a>
          </div>
          <div class="col-img">
            <a href="#"
              ><img src="@/assets/img\banner\banner3-5.jpg" alt="banner 3"
            /></a>
          </div>
        </div>
        <div class="banner-box">
          <div class="col-img">
            <a href="#"
              ><img src="@/assets/img\banner\banner3-6.jpg" alt="banner 3"
            /></a>
          </div>
        </div>
        <div class="banner-box">
          <div class="col-img">
            <a href="#"
              ><img src="@/assets/img\banner\banner3-7.jpg" alt="banner 3"
            /></a>
          </div>
          <div class="col-img">
            <a href="#"
              ><img src="@/assets/img\banner\banner3-8.jpg" alt="banner 3"
            /></a>
          </div>
        </div>
      </div>
        ...
        <div class="main-product-tab-area">
          <div class="tab-menu mb-25">
            ...
            <ul class="nav tabs-area" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#fshion"
                  >Fashion</a
                >
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#electronics"
                  >Sport/Outdoor</a
                >
              </li>
              <li class="nav-item">
                  ...
                  <div class="single-product">
                    ...
                    <div class="pro-img">
                      <a href="product.html">
                        <img
                          class="primary-img"
                          src="@/assets/img\products\40.jpg"
                          alt="single-product"
                        />
                        <img
                          class="secondary-img"
                          src="@/assets/img\products\41.jpg"
                          alt="single-product"
                        />
                      </a>
                      <a
                  ...
                  <div class="single-product">
                    ...
                    <div class="pro-img">
                      <a href="product.html">
                        <img
                          class="primary-img"
                          src="@/assets/img\products\39.jpg"
                          alt="single-product"
                        />
                        <img
                          class="secondary-img"
                  ...
                  <div class="single-product">
                    ...
                    <div class="pro-img">
                      <a href="product.html">
                        <img
                          class="primary-img"
                          src="@/assets/img\products\36.jpg"
                          alt="single-product"
                        />
                        <img
                          class="secondary-img"
                          src="@/assets/img\products\37.jpg"
                          alt="single-product"
                        />
                      </a>
                      <a
                    ...
                    <div class="pro-content">
                      <div class="pro-info">
                        ...
                        <p>
                          ...
                          ><del class="prev-price">$120.50</del>
                        </p>
                        <div class="label-product l_sale">
                          15<span class="symbol-percent">%</span>
                        </div>
                  ...
                  <div class="single-product">
                    ...
                    <div class="pro-img">
                      <a href="product.html">
                        <img
                          class="primary-img"
                          src="@/assets/img\products\35.jpg"
                          alt="single-product"
                        />
                        <img
                          class="secondary-img"
                    ...
                    <div class="pro-content">
                      <div class="pro-info">
                        ...
                        <p>
                          ...
                          ><del class="prev-price">$145.50</del>
                        </p>
                        <div class="label-product l_sale">
                          20<span class="symbol-percent">%</span>
                        </div>
                  ...
                  <div class="single-product">
                    ...
                    <div class="pro-img">
                      <a href="product.html">
                        <img
                          class="primary-img"
                          src="@/assets/img\products\34.jpg"
                          alt="single-product"
                        />
                        <img
                          class="secondary-img"
                    ...
                    <div class="pro-content">
                      <div class="pro-info">
                        <h4>
                          <a href="product.html"
                            >Compary and Bark Vortex Shewe</a
                          >
                        </h4>
                        <p>
                          <span class="price">$84.45</span
                  ...
                  <div class="single-product">
                    ...
                    <div class="pro-img">
                      <a href="product.html">
                        <img
                          class="primary-img"
                          src="@/assets/img\products\32.jpg"
                          alt="single-product"
                        />
                        <img
                          class="secondary-img"
                          src="@/assets/img\products\33.jpg"
                          alt="single-product"
                        />
                      </a>
                      <a
                  ...
                  <div class="single-product">
                    ...
                    <div class="pro-img">
                      <a href="product.html">
                        ...
                        <img
                          class="secondary-img"
                          src="@/assets/img\products\27.jpg"
                          alt="single-product"
                        />
                      </a>
                      <a
                  ...
                  <div class="single-product">
                    ...
                    <div class="pro-img">
                      <a href="product.html">
                        <img
                          class="primary-img"
                          src="@/assets/img\products\28.jpg"
                          alt="single-product"
                        />
                        <img
                          class="secondary-img"
                          src="@/assets/img\products\29.jpg"
                          alt="single-product"
                        />
                      </a>
                      <a
        ...
        <div class="main-product-tab-area">
          <div class="tab-menu mb-25">
            ...
            <ul class="nav tabs-area" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#electronics2"
                  >Sport/Outdoor</a
                >
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#kids2"
                  >Baby/Kids</a
                >
              </li>
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#fshion2"
                  >Fashion</a
                >
              </li>
            </ul>
          ...
          <div class="col-lg-6">
            ...
            <div class="brand-banner owl-carousel">
              <div class="single-brand">
                ...
                /></a>
                <a href="#"
                  ><img src="@/assets/img\brand\2.jpg" alt="brand-image"
                /></a>
                <a href="#"
                  ><img src="@/assets/img\brand\3.jpg" alt="brand-image"
                /></a>
              </div>
              <div class="single-brand">
                <a href="#"
              ...
              <div class="single-brand">
                <a href="#"
                  ><img src="@/assets/img\brand\1.jpg" alt="brand-image"
                /></a>
                <a href="#"
                  ><img src="@/assets/img\brand\2.jpg" alt="brand-image"
                /></a>
              ...
              <div class="single-brand">
                ...
                /></a>
                <a href="#"
                  ><img src="@/assets/img\brand\4.jpg" alt="brand-image"
                /></a>
              </div>
              <div class="single-brand">
                <a href="#"
        ...
        <div class="d-flex flex-wrap text-center">
          ...
          <div class="single-support">
            ...
            <div class="support-desc">
              ...
              <span
                >Quisque posuere enim augue, in rhoncus diam dictum non</span
              >
            </div>
          </div>
          <div class="single-support">
          ...
          <div class="single-support">
            ...
            <div class="support-desc">
              ...
              <span
                >Faucibus dictum suscipit eget metus. Duis elit sem, sed.</span
              >
            </div>
          </div>
          <div class="single-support">
              ...
              <div class="single-footer mb-sm-40">
                ...
                <div class="footer-content">
                  <ul class="footer-list address-content">
                    <li>
                      <i class="lnr lnr-map-marker"></i> Address: 169-C,
                      Technohub, Dubai Silicon Oasis.
                    </li>
                    <li>
                      <i class="lnr lnr-envelope"></i
                      ><a href="#"> mail Us: Support@truemart.com </a>
                    </li>
                    <li>
                      <i class="lnr lnr-phone-handset"></i> Phone: (+800) 123
                      456 789)
                    </li>
                  </ul>
          ...
          <div class="footer-middle-content pt-20 pb-30">
            <ul class="social-footer">
              ...
              <li>
                <a href="#"
                  ><img
                    src="@/assets/img\icon\social-img1.png"
                    alt="google play"
                /></a>
              </li>
              <li>
                <a href="#"
                  ><img src="@/assets/img\icon\social-img2.png" alt="app store"
                /></a>
              </li>
            </ul>
          </div>
      ...
      <div class="footer-bottom pb-30">
        <div class="container">
          <div class="copyright-text text-center">
            <p>
              Copyright © 2018 <a target="_blank" href="#">Truemart</a> All
              Rights Reserved.
            </p>
          </div>
        </div>
                  ...
                  <div class="col-lg-5 col-md-6 col-sm-5">
                    ...
                    <div class="tab-content">
                      ...
                      <div id="thumb2" class="tab-pane fade">
                        <a data-fancybox="images" href="img\products\13.jpg"
                          ><img
                            src="@/assets/img\products\13.jpg"
                            alt="product-view"
                        /></a>
                      ...
                      <div id="thumb3" class="tab-pane fade">
                        <a data-fancybox="images" href="img\products\15.jpg"
                          ><img
                            src="@/assets/img\products\15.jpg"
                            alt="product-view"
                        /></a>
                      ...
                      <div id="thumb5" class="tab-pane fade">
                        <a data-fancybox="images" href="img\products\5.jpg"
                          ><img
                            src="@/assets/img\products\5.jpg"
                            alt="product-view"
                        /></a>
                    ...
                    <div class="product-thumbnail mt-20">
                      <div
                        class="thumb-menu owl-carousel nav tabs-area"
                        role="tablist"
                      >
