...
import ArrivalsProduct from "../components/ArrivalsProduct.vue";
import SecondArrivalsProduct from "../components/SecondArrivalsProduct.vue";
import LikeProduct from "../components/LikeProduct.vue";
import MainBrandBanner from "../components/MainBrandBanner.vue";
import SupportArea from "../components/SupportArea.vue";
import FooterArea from "../components/FooterArea.vue";
import QuickView from "../components/QuickView.vue";
import SingleProduct from "../components_product/SingleProduct.vue";
import Header from "../components_product/Header.vue";
import Footer from "../components_product/Footer.vue";
...
export default {
  ...
  setup() {
    ...
    const dataTuThangCon = (data) => {
      ...
      axios.get("https://6419ba9ef398d7d95d47d12c.mockapi.io/demo/products/" + valueCon.value)
        .then((response) => {
          dataCallProduct.value = response.data
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 order-2 order-lg-1">
            <div class="sidebar">
              ...
              <div class="electronics mb-40">
                <h3 class="sidebar-title"><router-link to="/">Electronics</router-link></h3>
                <div id="shop-cate-toggle" class="category-menu sidebar-menu sidbar-style">
                  <ul>
                    <li class="has-sub">
                      <router-link to="/camera"><a href="#">Camera</a></router-link>
                    ...
                    <li class="has-sub">
                      <router-link to="/gamepad"><a href="#">gamepad</a></router-link>
                      <ul class="category-sub">
                  ...
                  <div class="side-pro-item">
                    ...
                    <div class="single-product single-product-sidebar">
                      ...
                      <div class="pro-img">
                        <a href="product.html">
                          ...
                          <img class="secondary-img" src="../assets/img\products\19.jpg" alt="single-product" />
                        </a>
                      ...
                      <div class="pro-content">
                        ...
                        <p>
                          <span class="price">$130.45</span><del class="prev-price">180.50</del>
                        </p>
                      </div>
                      <!-- Product Content End -->
                    </div>
                    ...
                    <div class="single-product single-product-sidebar">
                      ...
                      <div class="pro-content">
                        ...
                        <p>
                          <span class="price">$320.45</span><del class="prev-price">$400.50</del>
                        </p>
                      </div>
                      <!-- Product Content End -->
                    </div>
                    ...
                    <div class="single-product single-product-sidebar">
                      ...
                      <div class="pro-content">
                        ...
                        <p>
                          <span class="price">$150.45</span><del class="prev-price">$200.50</del>
                        </p>
                      </div>
                      <!-- Product Content End -->
                    </div>
                    ...
                    <div class="single-product single-product-sidebar">
                      ...
                      <div class="pro-img">
                        <a href="product.html">
                          <img class="primary-img" src="../assets/img\products\25.jpg" alt="single-product" />
                          <img class="secondary-img" src="../assets/img\products\26.jpg" alt="single-product" />
                        </a>
                      </div>
                      <!-- Product Image End -->
                      <!-- Product Content Start -->
                  ...
                  <div class="side-pro-item">
                    ...
                    <div class="single-product single-product-sidebar">
                      ...
                      <div class="pro-content">
                        ...
                        <p>
                          <span class="price">$80.45</span><del class="prev-price">$100.50</del>
                        </p>
                      </div>
                      <!-- Product Content End -->
                    </div>
                    ...
                    <div class="single-product single-product-sidebar">
                      ...
                      <div class="pro-img">
                        <a href="product.html">
                          <img class="primary-img" src="../assets/img\products\33.jpg" alt="single-product" />
                          <img class="secondary-img" src="../assets/img\products\34.jpg" alt="single-product" />
                        </a>
                      </div>
                      <!-- Product Image End -->
                      <!-- Product Content Start -->
                      <div class="pro-content">
                        ...
                        <p>
                          <span class="price">$120.45</span><del class="prev-price">130.50</del>
                        </p>
                      </div>
                      <!-- Product Content End -->
                    </div>
                    ...
                    <div class="single-product single-product-sidebar">
                      ...
                      <div class="pro-img">
                        <a href="product.html">
                          <img class="primary-img" src="../assets/img\products\31.jpg" alt="single-product" />
                          <img class="secondary-img" src="../assets/img\products\32.jpg" alt="single-product" />
                        </a>
                      </div>
                      <!-- Product Image End -->
                      <!-- Product Content Start -->
                      <div class="pro-content">
                        ...
                        <p>
                          <span class="price">$140.45</span><del class="prev-price">$150.50</del>
                        </p>
                      </div>
                      <!-- Product Content End -->
                    </div>
              ...
              <!-- Single Banner Start -->
              <div class="col-img">
                <a href="shop.html"><img src="../assets/img\banner\banner-sidebar.jpg" alt="slider-banner" /></a>
              </div>
              <!-- Single Banner End -->
            </div>
          </div>
          ...
          <div class="col-lg-9 order-1 order-lg-2">
            ...
            <div
              ...
              <div class="grid-list-view mb-sm-15">
                <ul class="nav tabs-area d-flex align-items-center">
                  ...
                  <li>
                    <a data-toggle="tab" href="#list-view"><i class="fa fa-list-ul"></i></a>
                  </li>
                </ul>
              </div>
            ...
            <form-data :dataCallProduct="dataCallProduct" @onDone="callApi"/>
            <!-- Grid & List View End -->
            <div class="main-categorie mb-all-40">
              ...
              <div class="tab-content fix">
                ...
                <div id="grid-view" class="tab-pane fade show active">
                  ...
                  <div class="row">
                    <!-- Single Product Start -->
                    <SingleProduct v-for="item in arrProducts" :key="item" :data="item" @dataItem="dataTuThangCon"
                      @dataDelete="xoaItem">
                    </SingleProduct>
                  </div>
                  <!-- Row End -->
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-8 col-md-7 col-sm-12">
                        <div class="pro-content hot-product2">
                          <h4>
                            <a href="product.html">Accessorize with a straw hat</a>
                          </h4>
                          ...
                          <p>
                            ...
                            summer!Faded short sleeves t-shirt with high
                            neckline. Soft and stretchy material.
                          </p>
                  ...
                  <div class="single-product">
                    <div class="row">
                      ...
                      <div class="col-lg-8 col-md-7 col-sm-12">
                        <div class="pro-content hot-product2">
                          <h4>
                            <a href="product.html">Tretchy Material Comfortable</a>
                          </h4>
                          <p>
                            <span class="price">$199.19</span><del class="prev-price">$205.50</del>
                          </p>
                          <p>
                            Faded short sleeves t-shirt with high neckline. Soft
                            and stretchy material for a comfortable fit.
                  ...
                  <div class="single-product">
                    <div class="row">
                      ...
                      <div class="col-lg-8 col-md-7 col-sm-12">
                        <div class="pro-content hot-product2">
                          <h4>
                            <a href="product.html">Neckline Short Sleeves Stretchy</a>
                          </h4>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-8 col-md-7 col-sm-12">
                        <div class="pro-content hot-product2">
                          ...
                          <p>
                            <span class="price">$152.19</span><del class="prev-price">$160.50</del>
                          </p>
                          <p>
                            Faded short sleeves t-shirt with high neckline. Soft
                            and stretchy material for a comfortable fit.
                  ...
                  <div class="single-product">
                    <div class="row">
                      ...
                      <div class="col-lg-8 col-md-7 col-sm-12">
                        <div class="pro-content hot-product2">
                          <h4>
                            <a href="product.html">Faded Short Sleeves T-shirt</a>
                          </h4>
                          <p>
                            <span class="price">$15.19</span><del class="prev-price">$16.50</del>
                          </p>
                          <p>
                            Faded short sleeves t-shirt with high neckline. Soft
                            and stretchy material for a comfortable fit.
