                ...
                <ul class="vertical-menu-list">
                  <li class="">
                    <a href="shop.html"
                      ><span
                        ><img
                          src="@/assets/img\vertical-menu\1.png"
                          alt="menu-icon" /></span
                      >Automotive & Motorcycle<i
                    ...
                    <ul class="ht-dropdown mega-child">
                      <li>
                        <a href="shop.html"
                          >Office chair <i class="fa fa-angle-right"></i
                        ></a>
                      ...
                      <li>
                        <a href="shop.html"
                          >Purus Lacus <i class="fa fa-angle-right"></i
                        ></a>
                        <!-- category submenu end-->
                        <ul class="ht-dropdown mega-child">
                  ...
                  <li>
                    <a href="shop.html"
                      ><span
                        ><img
                          src="@/assets/img\vertical-menu\3.png"
                          alt="menu-icon" /></span
                      >Sports & Outdoors<i
                        class="fa fa-angle-right"
                        aria-hidden="true"
                    ...
                    <ul class="ht-dropdown megamenu first-megamenu">
                      ...
                      <li class="megamenu-img">
                        <a href="shop.html"
                          ><img
                            src="@/assets/img\vertical-menu\sub-img1.jpg"
                            alt="menu-image"
                        /></a>
                        <a href="shop.html"
                          ><img
                            src="@/assets/img\vertical-menu\sub-img2.jpg"
                            alt="menu-image"
                        /></a>
                        <a href="shop.html"
                          ><img
                            src="@/assets/img\vertical-menu\sub-img3.jpg"
                            alt="menu-image"
                        /></a>
                      </li>
                  ...
                  <li>
                    <a href="shop.html"
                      ><span
                        ><img
                          src="@/assets/img\vertical-menu\6.png"
                          alt="menu-icon" /></span
                      >Fashion<i
                        class="fa fa-angle-right"
                        aria-hidden="true"
                  ...
                  <li>
                    <a href="shop.html"
                      ><span
                        ><img
                          src="@/assets/img\vertical-menu\7.png"
                          alt="menu-icon" /></span
                      >Home & Kitchen<i
                        class="fa fa-angle-right"
                        aria-hidden="true"
                  ...
                  <li>
                    <a href="shop.html"
                      ><span
                        ><img
                          src="@/assets/img\vertical-menu\4.png"
                          alt="menu-icon" /></span
                      >Phones & Tablets<i
                        class="fa fa-angle-right"
                        aria-hidden="true"
                  ...
                  <li>
                    <a href="shop.html"
                      ><span
                        ><img
                          src="@/assets/img\vertical-menu\5.png"
                          alt="menu-icon" /></span
                      >Beauty</a
                    >
                  </li>
                  <li>
                    <a href="shop.html"
                      ><span
                        ><img
                          src="@/assets/img\vertical-menu\8.png"
                          alt="menu-icon" /></span
                      >Fruits & Veggies</a
                    >
                  </li>
                  <li>
                    <a href="shop.html"
                      ><span
                        ><img
                          src="@/assets/img\vertical-menu\9.png"
                          alt="menu-icon" /></span
                      >Computer & Laptop</a
                    >
                  </li>
                  <li>
                    <a href="shop.html"
                      ><span
                        ><img
                          src="@/assets/img\vertical-menu\10.png"
                          alt="menu-icon" /></span
                      >Meat & Seafood</a
                    >
                  </li>
                        ...
                        <ul class="category-sub">
                          <li>
                            <a href="shop.html"
                              ><span
                                ><img
                                  src="@/assets/img\vertical-menu\11.png"
                                  alt="menu-icon" /></span
                              >Accessories</a
                            >
                          </li>
